...
const client = new tmi.Client({
    ...
    identity: {
        username: "thetomentosa", //Twitch kullanıcı adınız!
        password: "thlgavs08enr5yg4kcb4ie785urbsh" //OAuth key (README kısmında nasıl alacağınız mevcuttur.)
    },
   channels: ["nympeaaa"] //katılınacak kanalların adları Örn: ["Kanal1", "Kanal2", "Kanal3"] bu şekilde olmalıdır kesinlikle dikkat edin! 
});
